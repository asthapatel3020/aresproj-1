...
class EditQuestion extends Component {
	...
	handleNameChange(e) {
      ...
      if(this.state.question&&this.state.answers.length>1) {
        if(this.state.isLocal) {
          ...
          this.props.dispatch(actions.editLocalQuestionWh({...this.props.question, question:this.state.question, options:this.state.answers})); 
          this.props.router.push(`/questionswh`)
          
      		// this.state.answers.map((ans,i)=>answers.push({id:i+1, option:ans}))
        //   this.props.dispatch(actions.editLocalQuestionWh(this.state.questionswh, answers, )); 
        }
        else {
      ...
      nextProps.isSent&&this.props.router.push(`/questionswh`)
    ...
    handleDelete(e) {
      let answers = [];
      if(this.state.isLocal) {
          this.props.dispatch(actions.deleteLocalQuestionWh(this.props.question )); 
          this.props.router.push(`/questionswh`)
