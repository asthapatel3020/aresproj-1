...
class ListOfPatients extends Component  {
	...
	closeModal() {
		this.props.onClose(6)
		this.props.dispatch(reset('listOfPatientsForm'))

	}
	changeTabToReport() {
		this.setState({tab:1})
		this.props.dispatch(submit('listOfPatientsForm', ''))
	}
	render() {
						...
						<div style={{padding:'20px 0'}}>
							<div style={{width:'100%'}} className="d-flex flex-column align-items-start">
								...
								{tab==0&&<Form 
									...
									insCompanies={this.props.insCompanies}/>
								}
...
function mapStateToProps(state) {
  return {
  	...
  	insCompanies:state.insCompanies.companies
  };
}
