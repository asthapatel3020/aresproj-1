...
class DifferentPrices extends Component  {
	...
	componentWillMount() {
		this.props.filters.from&&this.props.dispatch(actions.getPricesProductStats(this.props.token, this.props.id, this.props.filters, 1))
		this.props.dispatch(actions.getCommentsProduct(this.props.token, this.props.id, this.props.filters, 1))
		
	}
	componentWillReceiveProps(nextProps) {
		nextProps.filters!==this.props.filters&&
		this.props.dispatch(actions.getPricesProductStats(this.props.token, this.props.id, nextProps.filters, 1))
