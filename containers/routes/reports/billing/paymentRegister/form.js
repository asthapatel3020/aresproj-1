...
const handleSubmit=(values, dispatch, props)=> {
  ...
  let final = {
    ...
    check_number: values.check_number?values.check_number:null,
    visit_types:values.visit_types_all?null:values.visit_type?values.visit_type:null
  }
  dispatch(actions.getPaymentRegister(props.token, final, 1))
...
class  PaymentByProviderForm extends PureComponent {
  ...
  render() {
    const { handleSubmit, submitting, errors, doctors, claimTypes, billStatuses, providers, services} = this.props
          ...
          <div style={{marginRight:15, width:'49%'}}>
            <div className='d-flex'> 
              <div>
                ...
                <div className="gray-border" style={{marginTop:10}}>
                  <div className="col-12" style={{fontWeight:500, fontSize:'1.1rem', textDecoration:'underline'}}>
                    Check number
                  </div>
                  <Field 
                ...
                <div className="gray-border" >
                    <div className="select-with-input">
                      <div style={{margin:'10px 0'}} className='d-flex justify-content-between'>
                        ...
                        <div >
                          <label>
                            <Field component="input" type="checkbox" name="visit_type_all" />
                           All
                          </label>
                        </div>
                      </div>
                      ...
                      <div style={{position:'relative'}}>
                        <div style={{position:'absolute', height:'100%', width:'100%', zIndex:2,display:this.props.visitTypeAll?'block':'none' }}></div>
                        <Field 
                        component={CheckBoxTable}  
                        name="visit_type" 
                        options={services}
...
const selector = formValueSelector('paymentRegisterForm');
...
export default connect(
  ...
  visitTypeAll:selector(state, 'visit_type_all'),
