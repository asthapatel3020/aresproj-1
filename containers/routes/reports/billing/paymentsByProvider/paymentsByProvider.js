...
class PaymentsByProvider extends Component  {
	state={
		tab:0
	}
	...
	closeModal() {
		...
		this.props.dispatch(reset('paymentsByProviderForm'))
		...
		return (
			<Modal 
				...
				<div style={{ width:'100%', background:'#fff', height:'100%', paddingBottom:'2rem', overflow:'auto'}}>
					<div className="modal-title">Payments by provider</div>
...
export default connect(mapStateToProps)(PaymentsByProvider);
