...
class BillingByProvider extends Component  {
	...
	closeModal() {
		this.props.onClose(3)
		this.props.dispatch(reset('billingByProviderForm'))

	}
	changeTabToReport() {
		this.setState({tab:1})
		this.props.dispatch(submit('billingByProviderForm', ''))
		...
		return (
			<Modal 
				...
				<div style={{ width:'100%', background:'#fff', height:'100%', paddingBottom:'2rem', overflow:'auto'}}>
					<div className="modal-title">Billing by provider</div>
